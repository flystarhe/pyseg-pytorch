...
# Loss function (see pyseg/models/loss.py for options)
...
# Transformation function (see pyseg/models/resnet.py for options)
...
_C.DOWNLOAD_CACHE = "/tmp/pyseg-download-cache"
...
def load_cfg_fom_args(description="Config file options."):
    ...
    help_s = "See pyseg/core/config.py for all options"
